...
# Patches a local platform-root/ with the exact S0 + S1 + A-11 + S2 file set from
# this session (15 files). Raw-file overwrite (no git remote required). Idempotent.
#
...
write 'shared/utils/lens.js' <<'__OBSIDIAN_DEPLOY_EOF__'
...
echo "[deploy] done — 15 files written."
